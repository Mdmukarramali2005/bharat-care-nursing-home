...
""")
    ...
    # Queue workflow was simplified to Waiting / Completed / No Show only.
    # Any older records left in the retired 'called' or 'in_consultation'
    # states are folded back into 'waiting' so they still show up correctly.
    cursor.execute(
        "UPDATE appointments SET queue_status='waiting' WHERE queue_status IN ('called','in_consultation')"
    )
    ...
    if cursor.fetchone()[0] == 0:
        ...
        doctors_data = [
            ...
            (
                ...
                15,
                500,
                "10:00 AM - 05:00 PM (Only Monday to Wednesday)",
                5.0,
                "+919472396918",
                "+919472396918",
